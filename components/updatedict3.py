...
# updateDict2(10, 10 ,10,10,2000,2020,100,100,'hapusdata')
...
def updateDict3(train,test) :
    ...
    dffinal.columns=['Date','Close','gatauiniapa','warna']
...
app.layout = html.Div([
                ...
                dcc.Graph(
                    ...
                    figure={
                        'data': [
                            go.Scatter(
                                # x=dfypred['Datecadangan'],
                                x=dffinal['Date'],
                                # y=dfypred['Predictions'],
                                y=dffinal['Close'],
                                mode='lines',
